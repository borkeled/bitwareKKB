...
public:
    ...
    ImFont* get(const std::vector<unsigned char>& font_data, float size, bool private_glyphs = false);
...
private:
    ...
    void add(const std::vector<unsigned char>& font_data, float size, bool private_glyphs = false);

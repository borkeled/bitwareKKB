...
namespace Offsets {
    inline std::string ClientVersion() { return std::string(skCrypt("version-8884371d30284041")); }
    ...
    namespace RenderView {
         ...
         inline constexpr uintptr_t SkyValidAlt = 0x2cd;
    ...
    namespace Workspace {
         ...
         inline constexpr uintptr_t TerrainPhysics = 0x3D8;
    ...
    namespace World {
         ...
         inline constexpr uintptr_t SkyDistance = 0x658;
